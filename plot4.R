...
#draw plot 4 and save it.
png("plot4.png", width = 480, height = 480)
par(mfrow = c(2, 2))
with(power, {
        plot(gap ~ time, type = "l", xlab = "", ylab= "Global Active Power")
        plot(vol ~ time, type = "l", xlab = "datatime", ylab= "Voltage")
        ...
        plot(grp ~ time, type = "l", xlab = "datatime", ylab = "Global_reactive_power")
}        
)
